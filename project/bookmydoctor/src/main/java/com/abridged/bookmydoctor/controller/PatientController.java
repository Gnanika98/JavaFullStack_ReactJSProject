...
public class PatientController {
	...
	public PatientResponse patientLogin(String email, String password) {
		boolean isLoggedIn = patientService.loginPatient(email, password);
		PatientResponse response = new PatientResponse();
		if (isLoggedIn) {
	...
	@GetMapping(path = "/getallappointmentsofpatient/{patientId}", produces = MediaType.APPLICATION_JSON_VALUE)
	public AppointmentResponse getAllAppointmentsByPatient(@PathVariable("patientId") int patientId) {
